    ...
    <div className="mx-auto max-w-5xl space-y-10">
      ...
      >
            ...
            return (
              <article
                ...
                className={`max-w-3xl border-l-2 px-4 py-3 ${
                  isUser
                    ? "ml-auto border-foreground bg-background"
                    : "mr-auto border-primary bg-white"
                }`}
              >
                <p
        ...
        <form
          ...
          className="grid gap-3 border-t border-border bg-background p-4 md:grid-cols-[1fr_auto]"
        >
          <input
            value={draft}
